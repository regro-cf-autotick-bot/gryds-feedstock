...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gryds-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15391&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gryds-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gryds` can be installed with:

```
conda install gryds
```

It is possible to list all of the versions of `gryds` available on your platform with:
